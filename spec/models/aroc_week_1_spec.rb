...
# You can comment out the Ruby example after your AR is working. 
  ...
  it '5. finds multiple items by id' do
    ...
    # ------------------ Using ActiveRecord ----------------------
      # items = Item.where("id = #{@item_1.id} or id = #{@item_2.id} or id = #{@item_4.id}")
  ...
  it '7. finds orders with an amount between 700 and 1000' do
    ...
    # ------------------ Using ActiveRecord ----------------------
      ...
      # orders_between_700_and_1000 = Order.where("amount > 700 AND amount < 1000").to_a ##i dont get why this doesnt work
    # ------------------------------------------------------------
